...
//			sendMessage(tema, idSensor, "Evento " + i);
	...
	public void sendMessage(String topic, String key, String message) {
		kafkaTemplate.send(topic, key, message).addCallback(
				result -> LOG.info(String.format("TOPIC: %s, KEY: %s, MESSAGE: %s, OFFSET: %s", topic, key, message,
						result.getRecordMetadata().offset())),
				ex -> LOG.error(String.format("TOPIC: %s, KEY: %s, MESSAGE: %s, ERROR: %s", topic, key, message,
						ex.getMessage())));
	}
